...
public class TextQuintet implements WritableComparable<TextQuintet> {
	...
	public TextQuintet(String first,String second,String third,String fourth,
			String fifth) {
...
//	static {
////	Registers TextQuintetComparator as default comparator of TextQuintet.class
//		WritableComparator.define(TextQuintet.class, new TextQuintetComparator());
//	}
	...
	public static class TextQuintetFirstComparator extends WritableComparator {
		...
		public int compare(WritableComparable a, WritableComparable b) {
			if (a instanceof TextQuintet && b instanceof TextQuintet) {
				return ((TextQuintet) a).first.compareTo(((TextQuintet) b).first);
			}
