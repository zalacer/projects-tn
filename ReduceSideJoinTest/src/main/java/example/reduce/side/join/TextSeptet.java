...
public class TextSeptet implements WritableComparable<TextSeptet> {
	...
	public static class TextSeptetComparator extends WritableComparator {
//		A RawComparator for comparing TextSeptet byte representations
		private static final Text.Comparator TEXT_COMPARATOR = new Text.Comparator();

		public TextSeptetComparator() {
...
//	static {
////	Registers TextSeptetComparator as default comparator of TextSeptet.class
//		WritableComparator.define(TextSeptet.class, new TextSeptetComparator());
//	}


	public static class TextSeptetFirstComparator extends WritableComparator {

		private static final Text.Comparator TEXT_COMPARATOR = new Text.Comparator();

		public TextSeptetFirstComparator() {
			super(TextSeptet.class);
		}
