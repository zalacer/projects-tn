...
External library dependencies are included in the distribution in the ExternalDependencies folder
and can be downloaded from the following locations: 

dependency              download location
======================= =========================================================================
algs4.jar               http://algs4.cs.princeton.edu/code/
classmexer.jar          http://www.javamex.com/classmexer/
