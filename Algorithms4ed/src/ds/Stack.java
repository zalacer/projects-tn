...
public class Stack<Item> implements Iterable<Item> {
  ...
  public Stack<Item> reverse() {
    Stack<Item> reverse = new Stack<>();
    for (Item i : this) reverse.push(i);
    return reverse;
  }
  ...
  public Stack<Item> clone() { return new Stack<Item>(reverse()); }
  ...
  public String reverseRawString() {
    StringBuilder sb = new StringBuilder();
    if (isEmpty()) return "";
    for (Item i : reverse()) sb.append(i);
  ...
  public static void main(String[] args) {
    ...
    Stack<Integer> s4 = s3.clone();
    System.out.println("s4="+s4);
    Stack<Integer> s5 = new Stack<Integer>();
    System.out.println("s5="+s5);
    Stack<Integer> s6 = s5.clone();
    System.out.println("s6="+s6);
    
    Stack<Integer> s7 = new Stack<Integer>(1,2,3,4,5);
    System.out.println("s7="+s7); 
    System.out.println("s7.clone="+s7.clone());
    System.out.println("s7.reverse="+s7.reverse());
    System.out.println("s7.reverseRawString="+s7.reverseRawString());
