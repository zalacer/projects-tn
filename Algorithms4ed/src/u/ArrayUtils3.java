...
//    // this method is to support the box and unbox method series
...
//  }
//  
//  private static Object box(Object a) {
...
//    int dim = dim(a);
//    if (dim < 1 || dim > 256) throw new IllegalArgumentException("box "
//        + "dimension of argument must be > 0 and  < 257");
//    
//    if (dim > 1) return box(a,dim);
//    
...
//    
//    switch (t) {
//    // doing it this way vs. using Array.set and Array.get based on performance tests
//      case "byte":
...
//  }
//  
//  private static Object box(Object a, int n) {
//    if( a == null) throw new IllegalArgumentException("box: "
//        + "argument can't be null");
//    if (!isPrimitiveArray(a)) throw new IllegalArgumentException("box: "
//        + "argument must be an array of primitive");
//    int dim = dim(a);
//    if (dim != n) throw new IllegalArgumentException("box: int n must "
//        + "be identical to the dimension of a");
//    
//    if (dim == 1) return box(a);
//    
//    String t = primordialComponentType(a);
//    String nt = null;
//    String prefix = repeat('[', n-1);
//    
//    switch (t) {
...
//    for (int i = 0; i < len; i++)
//      Array.set(array,i,box(Array.get(a,i), n-1));
//    return array;
//  }
//  
