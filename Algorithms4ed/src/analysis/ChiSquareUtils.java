...
public class ChiSquareUtils {
  ...
  public static int getFirstDigits(double x) {
    String s = ""+x;  
//    System.out.println(s);
    s = String.format("%4.4f", x); 
//    System.out.println(s);
    if (x < 1) s = s.replaceAll(".*\\.", "");
//    System.out.println(s);
    s = s.replaceAll("[^0-9]","");
//    System.out.println(s);
...
//    System.out.println(pochisq(23.21, 10));
    System.out.println(getFirstDigits(pochisq(2.314, 1))); //1281
    System.out.println(getFirstDigits(pochisq(2.314, 2))); //3144
    System.out.println(getFirstDigits(pochisq(17, 1))); //7380
    System.out.println(getFirstDigits(pochisq(1, 1))); //3173
    System.out.println(getFirstDigits(pochisq(3, 2))); //2231
    System.out.println(getFirstDigits(pochisq(12, 1))); //5
