...
public class MaxPQInt implements Iterable<Integer> {
   ...
   */
  public MaxPQInt(int initCapacity) {
...
//    System.out.println("exch("+pq[i]+","+pq[j]+")");
  ...
  public static Tuple2<Integer,List<int[]>> findHeapsWithMinOrMaxExchsForXdelMax(
    ...
    MaxPQInt pq; int min=Integer.MAX_VALUE, max=Integer.MIN_VALUE, e; 
