...
//        for (int i = 0; i <= maxN; i++) qp[i] = -1;
    ...
    public IndexMinPQ(IndexMinPQ<Key> p) {
      if (p == null) throw new IllegalArgumentException("IndexMinPQ<Key> p is null");
      maxN = p.maxN;
      n = p.n;
      pq = p.pq.clone();
      qp = p.qp.clone();
    ...
    @Override
    public IndexMinPQ<Key> clone() { return new IndexMinPQ<>(this); }
