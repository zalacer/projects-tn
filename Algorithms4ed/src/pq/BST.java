...
// https://github.com/coder-pft/Data-Structures-in-Java/blob/master/Tree/BST.java
...
public class BST {
  ...
  public static void main(String[] args) {
    ...
    head.closest(8); System.out.println();
//    System.out.println("Tree:\n" + head.toString());   
    System.out.println("search 7:" + head.search(7));
    head.remove(7);
    System.out.println("search 7:" + head.search(7));
