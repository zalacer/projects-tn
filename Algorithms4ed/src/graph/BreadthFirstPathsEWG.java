...
// but using EdgeWeightedGraphX instead of Graph

public class BreadthFirstPathsEWG {
  ...
  public BreadthFirstPathsEWG(EdgeWeightedGraphX G, int s) {
...
//    System.out.println("check returned "+chk+"\n");
  ...
  public BreadthFirstPathsEWG(EdgeWeightedGraphX G, Iterable<Integer> sources) {
  ...
  private void bfs(EdgeWeightedGraphX G, int s) {
  ...
  private void bfs(EdgeWeightedGraphX G, Iterable<Integer> sources) {
  ...
  private boolean check(EdgeWeightedGraphX G, int s) {
//    System.out.println("check() messages:");
  ...
  public static void bfSearch(String file, int source) {
    ...
    EdgeWeightedGraphX G = new EdgeWeightedGraphX(new In(file));
    BreadthFirstPathsEWG bfs = new BreadthFirstPathsEWG(G,source);
