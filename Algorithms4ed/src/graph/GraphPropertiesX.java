...
public class GraphPropertiesX implements GraphPropertiesAPI {
  ...
  public GraphPropertiesX(GraphX G) {
...
//        "GraphPropertiesX : G is cyclic");
    for (int i = 0; i < V; i++) 
      eccentricities[i] = (new BreadthFirstPathsX(G,i)).longestPathLength();
...
//    GraphX G = new GraphX(in);
    GraphPropertiesX gp = new GraphPropertiesX(GraphGeneratorX.tree(55));
