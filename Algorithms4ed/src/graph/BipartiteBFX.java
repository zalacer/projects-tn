...
// from http://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/BipartiteX.java

public class BipartiteBFX {
  ...
  public BipartiteBFX(GraphX G) {
    isBipartite = true;
    color  = new boolean[G.V()];
    marked = new boolean[G.V()];
    edgeTo = new int[G.V()];
    for (int v = 0; v < G.V() && isBipartite; v++) { if (!marked[v]) bfs(G, v); }
    assert check(G);
  }
  ...
  public static void main(String[] args) {
    ...
    BipartiteBFX b = new BipartiteBFX(G);
    if (b.isBipartite()) {
