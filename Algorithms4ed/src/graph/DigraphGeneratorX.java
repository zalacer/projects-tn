...
// from http://algs4.cs.princeton.edu/42digraph/DigraphGenerator.java

public class DigraphGeneratorX {
   ...
   */
  public static DigraphX simple(int V, double p) {
    if (p < 0.0 || p > 1.0)
   ...
   */
  public static DigraphX complete(int V) {
   ...
   */
  public static DigraphX dag(int V, int E) {
   ...
   */
  public static DigraphX tournament(int V) {
    DigraphX G = new DigraphX(V);
    for (int v = 0; v < G.V(); v++) {
   ...
   */
  public static DigraphX rootedInDAG(int V, int E) {
    if (E > (long) V*(V-1) / 2) throw new IllegalArgumentException("Too many edges");
   ...
   */
  public static DigraphX rootedOutDAG(int V, int E) {
    if (E > (long) V*(V-1) / 2) throw new IllegalArgumentException("Too many edges");
    if (E < V-1)                throw new IllegalArgumentException("Too few edges");
    DigraphX G = new DigraphX(V);
    SET<Edge> set = new SET<Edge>();
   ...
   */
  public static DigraphX rootedInTree(int V) {
   ...
   */
  public static DigraphX rootedOutTree(int V) {
   ...
   */
  public static DigraphX path(int V) {
    DigraphX G = new DigraphX(V);
    int[] vertices = new int[V];
    for (int i = 0; i < V; i++)
      vertices[i] = i;
   ...
   */
  public static DigraphX binaryTree(int V) {
    DigraphX G = new DigraphX(V);
    int[] vertices = new int[V];
    for (int i = 0; i < V; i++)
      vertices[i] = i;
   ...
   */
  public static DigraphX cycle(int V) {
    DigraphX G = new DigraphX(V);
    int[] vertices = new int[V];
    for (int i = 0; i < V; i++)
      vertices[i] = i;
   ...
   */
  public static DigraphX eulerianCycle(int V, int E) {
    if (E <= 0)
   ...
   * @throws IllegalArgumentException if either {@code V <= 0} or {@code E < 0}
   */
  public static DigraphX eulerianPath(int V, int E) {
    if (E < 0)
   ...
   */
  public static DigraphX strong(int V, int E, int c) {
    if (c >= V || c <= 0)
