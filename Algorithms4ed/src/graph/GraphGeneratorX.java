...
public class GraphGeneratorX {
  ...
  private GraphGeneratorX() { }

  public static GraphX simple(int V, int E) {
  ...
  public static GraphX simple(int V, double p) {
  ...
  public static GraphX complete(int V) {
    // return the complete graph on V vertices
    return simple(V, 1.0);
  }

  public static GraphX completeBipartite(int V1, int V2) {
  ...
  public static GraphX bipartite(int V1, int V2, int E) {
  ...
  public static GraphX bipartite(int V1, int V2, double p) {
    // return a random bipartite simple graph on V1 and V2 vertices where V1 is the
    // number of vertices in one partition and V2 is the number of vertices in
  ...
  public static GraphX path(int V) {
  ...
  public static GraphX binaryTree(int V) {
  ...
  public static GraphX cycle(int V) {
  ...
  public static GraphX eulerianCycle(int V, int E) {
  ...
  public static GraphX eulerianPath(int V, int E) {
  ...
  public static GraphX wheel(int V) {
  ...
  public static GraphX star(int V) {
   ...
   */
  public static GraphX tree(int V) {
