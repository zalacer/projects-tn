...
public class BreadthFirstPathsX {
  ...
  public BreadthFirstPathsX(GraphX G, int s) {
...
//    System.out.println("check returned "+chk+"\n");
  ...
  public BreadthFirstPathsX(GraphX G, int s, String type) {
  ...
  public BreadthFirstPathsX(GraphX G, Iterable<Integer> sources) {
  ...
  private void bfstack(GraphX G, int s) {
  ...
  private void bfs(GraphX G, Iterable<Integer> sources) {
  ...
  private void bfstack(GraphX G, Iterable<Integer> sources) {
    // for Ex4114 - using a stack instead of a queue in bfs
  ...
  private boolean check(GraphX G, int s) {
//    System.out.println("check() messages:");
  ...
  public static void bfSearch(String file, int source) {
    ...
    GraphX G = new GraphX(new In(file));
    BreadthFirstPathsX bfs = new BreadthFirstPathsX(G,source);
  ...
  public static void bfSearch(String file, int source, String type) {
    ...
    if (!(type.equals("q")||type.equals("s"))) throw new IllegalArgumentException(
        "BreadthFirstPathsX: type isn't \"q\" or \"s\"");
    GraphX G = new GraphX(new In(file));
    BreadthFirstPathsX bfs = null;
    if (type.equals("s")) bfs = new BreadthFirstPathsX(G,source, "s");
    else bfs = new BreadthFirstPathsX(G,source);
    StdOut.println("Paths:");
    for (int v = 0; v < bfs.V(); v++) {
      if (bfs.hasPathTo(v)) {
        StdOut.printf("%d to %d (%d):  ", source, v, bfs.distTo(v));
...
//    bfSearch("tinyGex2.txt",0,"s");
    ...
    System.out.print("G.adj="); par(G.adj());
