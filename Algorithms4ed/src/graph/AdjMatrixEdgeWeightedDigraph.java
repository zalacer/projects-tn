...
/******************************************************************************
 *  http://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/AdjMatrixEdgeWeightedDigraph.java
 *  http://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/AdjMatrixEdgeWeightedDigraph.java.html
 *  Compilation:  javac AdjMatrixEdgeWeightedDigraph.java
 *  Execution:    java AdjMatrixEdgeWeightedDigraph V E
 *  Dependencies: StdOut.java
 *
 *  An edge-weighted digraph, implemented using an adjacency matrix for dense graphs.
