...
import v.Tripwire;
import v.ArrayUtils.BooleanConsumer;
import v.ArrayUtils.ByteConsumer;
import v.ArrayUtils.CharConsumer;
import v.ArrayUtils.FloatConsumer;
import v.ArrayUtils.ShortConsumer;


//http://grepcode.com/file/repository.grepcode.com/java/root/jdk/openjdk/8u40-b25/java/util/PrimitiveIterator.java/
...
public interface PrimitiveIterator<T, T_CONS> extends Iterator<T> {
  ...
  public static interface OfChar extends PrimitiveIterator<Character, CharConsumer> {
    ...
    default Character next() {
      if (Tripwire.ENABLED)
        Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfChar.nextChar()");
      return nextChar();
    }
    ...
    default void forEachRemaining(Consumer<? super Character> action) {
      if (action instanceof CharConsumer) {
        ...
        Objects.requireNonNull(action);
        if (Tripwire.ENABLED)
          Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfChar.forEachRemainingChar(action::accept)");
  ...
  public static interface OfByte extends PrimitiveIterator<Byte, ByteConsumer> {
    ...
    default Byte next() {
      if (Tripwire.ENABLED)
        Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfByte.nextByte()");
      return nextByte();
    }
    ...
    default void forEachRemaining(Consumer<? super Byte> action) {
      if (action instanceof ByteConsumer) {
        ...
        Objects.requireNonNull(action);
        if (Tripwire.ENABLED)
          Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfByte.forEachRemainingByte(action::accept)");
  ...
  public static interface OfShort extends PrimitiveIterator<Short, ShortConsumer> {
    ...
    default Short next() {
      if (Tripwire.ENABLED)
        Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfShort.nextShort()");
      return nextShort();
    }
    ...
    default void forEachRemaining(Consumer<? super Short> action) {
      if (action instanceof ShortConsumer) {
        ...
        Objects.requireNonNull(action);
        if (Tripwire.ENABLED)
          Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfShort.forEachRemainingShort(action::accept)");
  ...
  public static interface OfFloat extends PrimitiveIterator<Float, FloatConsumer> {
    ...
    default Float next() {
      if (Tripwire.ENABLED)
        Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfFloat.nextFloat()");
      return nextFloat();
    }
    ...
    default void forEachRemaining(Consumer<? super Float> action) {
      if (action instanceof FloatConsumer) {
        ...
        Objects.requireNonNull(action);
        if (Tripwire.ENABLED)
          Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfFloat.forEachRemainingFloat(action::accept)");
  ...
  public static interface OfBoolean extends PrimitiveIterator<Boolean, BooleanConsumer> {
    ...
    default Boolean next() {
      if (Tripwire.ENABLED)
        Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfBoolean.nextBoolean()");
      return nextBoolean();
    }
    ...
    default void forEachRemaining(Consumer<? super Boolean> action) {
      if (action instanceof BooleanConsumer) {
        ...
        Objects.requireNonNull(action);
        if (Tripwire.ENABLED)
          Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.Boolean.forEachRemainingBoolean(action::accept)");
