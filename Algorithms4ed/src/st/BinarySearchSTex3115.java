...
public class BinarySearchSTex3115<Key extends Comparable<Key>, Value> {
    ...
    public BinarySearchSTex3115() { this(INIT_CAPACITY); }

    public BinarySearchSTex3115(int capacity) { 
        keys = (Key[]) new Comparable[capacity]; 
        vals = (Value[]) new Object[capacity];
        t = new Timer();
    }
    
    public BinarySearchSTex3115(Key[] ka, Value[] va) {
      t = new Timer();
    ...
    public int getPutTime() { return time; }
