...
public class SETint implements OrderedSETint {
  ...
  @Override public boolean contains(int key) { return get(key); }
  ...
  @Override public Iterator<Integer> iterator() { return keys().iterator(); }
