...
/**
 * https://github.com/joacima/Cuckoo-hash-map/blob/master/CuckooHashMap.java
 * Cuckoo Hash Map
 * 
...
public class CuckooHashMapJoacima<K, V> extends AbstractMap<K, V> implements Map<K, V> {
  ...
  public static void main(String[] args) {
    Map<Integer, String> map = new CuckooHashMapJoacima<Integer, String>();
    int itemCount = 25;
  ...
  static class Entry<K, V> implements Map.Entry<K, V> {
    ...
    public final K getKey() {
      return CuckooHashMapJoacima.unmaskNull(key);
    }
  ...
  public CuckooHashMapJoacima() {
    this.loadFactor = DEFAULT_LOAD_FACTOR;
    threshold = (int) (DEFAULT_INITIAL_CAPACITY * DEFAULT_LOAD_FACTOR);
    table = ofDim(Entry.class, DEFAULT_INITIAL_CAPACITY);
    hash1 = new DefaultHashFunction<K>(2);
    hash2 = new DefaultHashFunction<K>(3);
    init();
  }

  public CuckooHashMapJoacima(HashFunction<K> h1, HashFunction<K> h2) {
    this(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, h1, h2);
  }

  public CuckooHashMapJoacima(int initialCapacity) {
    this(initialCapacity, DEFAULT_LOAD_FACTOR);
  }

  public CuckooHashMapJoacima(int initialCapacity, float loadFactor) {
  ...
  public CuckooHashMapJoacima(int initialCapacity, float loadFactor,
    ...
    table = ofDim(Entry.class, capacity);
    hash1 = h1;
    hash2 = h2;
    init();
  }

  public CuckooHashMapJoacima(Map<? extends K, ? extends V> m) {
  ...
  private void rehash(int newCapacity) {
    ...
    Entry<K, V>[] newTable = ofDim(Entry.class,newCapacity);
