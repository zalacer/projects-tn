...
public class HashSETint implements UnorderedSETint {
  ...
  public HashSETint() {this(INIT_CAPACITY); }
  ...
  public void clear() { keys = new int[m]; n = 0; }
  ...
  public Iterator<Integer> iterator() {  return keys().iterator(); }
