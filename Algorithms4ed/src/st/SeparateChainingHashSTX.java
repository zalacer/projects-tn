...
public class SeparateChainingHashSTX<Key, Value> {
  ...
  private SequentialSearchSTX<Key, Value>[] st;
...
//    System.out.println("prime="+primes[(int)lg(ma[0])+5]);
  ...
  public SeparateChainingHashSTX(String t) {
  ...
  public SeparateChainingHashSTX(Key[] ka, Value[] va) {
...
//    if (ap > tolerance) return adj > 2 ? adj*m : 2*m;
  ...
  private void resize(int chains) {
    SeparateChainingHashSTX<Key, Value> temp = 
        new SeparateChainingHashSTX<Key, Value>(chains);
    for (int i = 0; i < m; i++) {
  ...
  public static void main(String[] args) { 
    ...
    t = new Timer();
    SeparateChainingHashSTX<Double,Integer> sv = new SeparateChainingHashSTX<>(d,e);
    ...
    SeparateChainingHashSTX<String, Integer> h = 
        new SeparateChainingHashSTX<String, Integer>(a,b);
    par(h.toKeyArray());
    par(h.toValArray());
