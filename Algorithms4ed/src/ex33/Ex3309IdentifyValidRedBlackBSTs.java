...
/* p449 
  ...
  FYI this is answered on http://algs4.cs.princeton.edu/33balanced/.
  as follows:
  "Solution. (iii) and (iv) only. (i) is not balanced, (ii) is not in 
  symmetric order or balanced."
 */             

public class Ex3309IdentifyValidRedBlackBSTs {
