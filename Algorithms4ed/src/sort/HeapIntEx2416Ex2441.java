...
// for Ex2416 and Ex2441 

@SuppressWarnings("unused")
public class HeapIntEx2416Ex2441 {
  public static long compares = 0;

    // This class should not be instantiated.
    private HeapIntEx2416Ex2441() { }
    ...
    ***************************************************************************/
    ...
    public static void findMinCompares() {
      // ex2416
      int[] z = range(1,33), w=null, x, y; long min=Long.MAX_VALUE; double c = 0;
    ...
    public static void findRandomMinCompares() {
      ...
      // ex2416
      int[] z = range(1,33), w=null, x; long min=Long.MAX_VALUE; double c = 0;
      Random r;
      while (true) {
    ...
    public static void findMaxCompares() {
      // ex2416
      int[] z = range(1,33), w=null, x, y; long max=Long.MIN_VALUE; double c = 0;
      Iterator<int[]> it = permutations(z);
      while (it.hasNext()) {
        c++;
        x = it.next(); y = x.clone();
    ...
    public static void main(String[] args) {
      ...
      int[] a = {3,1,5,4,12,6,2,7,11,10,9};
      sort(a);
      par(a);
