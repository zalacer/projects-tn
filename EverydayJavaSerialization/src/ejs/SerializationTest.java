...
import testclasses.Annotated;
import testclasses.B;
import testclasses.Cir1;
import testclasses.Cir2a;
import testclasses.Cir2b;
import testclasses.Cir3a;
import testclasses.Cir3b;
import testclasses.Cir3c;
import testclasses.Cir5a;
import testclasses.Cir5b;
import testclasses.Cir5c;
import testclasses.Cir5d;
import testclasses.Cir5e;
import testclasses.Cir9a;
import testclasses.Cir9b;
import testclasses.Cir9c;
import testclasses.Cir9d;
import testclasses.Cir9e;
import testclasses.Cir9f;
import testclasses.Cir9g;
import testclasses.Cir9h;
import testclasses.Cir9i;
import testclasses.Cir9j;
import testclasses.Cir9k;
import testclasses.Empty;
import testclasses.NotAnnotated;
import testclasses.Numbers;
import testclasses.TransientTest;
...
public class SerializationTest {
  ...
  public static final void encryptString2File(String data, String pathName, String pwd) {
    Serialization.encryptString2File(data, pathName, pwd);
  }
  
  public static final String decryptFile2String(String path, String...keyPath) {
    return Serialization.decryptFile2String(path, keyPath);
  }
  
  public static final <K, V> HashMap<V, K> invert(Map<K, V> map) {
    return serialization.invert(map);
  }
