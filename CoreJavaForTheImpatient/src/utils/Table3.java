...
public class Table3<K, V> {
  ...
  public class Entry3 {
    ...
    public boolean equals(Object obj) {
      ...
      if (obj == null)
        return false;
      if (!(obj instanceof  Table3.Entry3))
        return false;
      @SuppressWarnings("rawtypes")
      Table3.Entry3 other = (Table3.Entry3) obj;
      if (key == null) {
        if (other.key != null)
          return false;
  ...
  private ArrayList<Entry3> a;

  public Table3(){};

  public Table3(ArrayList<Entry3> a) {
    this.a = a;
  }

  // a factory
  public ArrayList<Entry3> getA() {
    if (a == null) a = new ArrayList<>();
    return a;
  }

  public void setA(ArrayList<Entry3> a) {
    this.a = a;
  }
  ...
  public Object getAllEntries(K key) {
    if (a == null) return false;
    ArrayList<Entry3> b = new ArrayList<>();
  ...
  public boolean put(K key, V value) {
    Entry3 e = new Entry3(key, value);
    if (a == null) getA();
    a.add(e);
    return true;
  }

  public boolean put(Entry3 e) {
    if (a == null) getA();
    a.add(e);
    return true;
  }
  ...
  public boolean remove(Entry3 e) {
    if (a == null) return false;
    return a.remove(e);
  }
