...
// *
// * <p>The {@link #next} and {@link #} methods and their
// * primitive-type companion methods (such as {@link #nextInt} and
// * {@link #Int}) first skip any input that matches the delimiter
// * pattern, and then attempt to return the next token. Both <tt></tt>
// * and <tt>next</tt> methods may block waiting for further input.  Whether a
// * <tt></tt> method blocks has no connection to whether or not its
...
//
//    // Pattern found in last  operation
//    private Pattern Pattern;
//
//    // Position after last  operation
//    private int Position;
//
//    // Result after last  operation
...
//     * to scan, even if a previous invocation of {@link #} returned
//     * <code>true</code>.
//     *
...
//     *
//     * <p> An invocation of this method of the form <tt>(pattern)</tt>
//     * behaves in exactly the same way as the invocation
//     * <tt>(Pattern.compile(pattern))</tt>.
//     *
...
//     * @throws IllegalStateException if this scanner is closed
//     */
//    public boolean (String pattern)  {
//        return (patternCache.forName(pattern));
//    }
//
//    /**
...
//     * @throws IllegalStateException if this scanner is closed
//     */
//    public boolean (Pattern pattern) {
//        ensureOpen();
//        if (pattern == null)
...
//     * invocation of {@link #(Pattern)} returned <code>true</code>.
...
//     * @throws IllegalStateException if this scanner is closed
//     */
//    public boolean Byte(int radix) {
//        setRadix(radix);
//        boolean result = (integerPattern());
//        if (result) { // Cache it
//            try {
//                String s = (matcher.group(SIMPLE_GROUP_INDEX) == null) ?
//                    processIntegerToken(Result) :
//                    Result;
...
//     * @throws IllegalStateException if this scanner is closed
//     */
//    public boolean Short(int radix) {
//        setRadix(radix);
//        boolean result = (integerPattern());
//        if (result) { // Cache it
//            try {
...
//        setRadix(10);
//        boolean result = (floatPattern());
//        if (result) { // Cache it
//            try {
//                String s = processFloatToken(Result);
...
//        return BigInteger(defaultRadix);
//    }
//
//    /**
//     * Returns true if the next token in this scanner's input can be
...
//     * @throws IllegalStateException if this scanner is closed
//     */
//    public boolean BigInteger(int radix) {
//        setRadix(radix);
//        boolean result = (integerPattern());
//        if (result) { // Cache it
//            try {
