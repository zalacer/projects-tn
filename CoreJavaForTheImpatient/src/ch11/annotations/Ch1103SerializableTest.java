...
public class Ch1103SerializableTest {
  
  public static final Ch1103Serializable s3 = new Ch1103Serializable();
  
  public static final void setUseAnnotation(boolean b) {
    s3.setUseAnnotation(b);
  }
  ...
  public static void main(String[] args) {
    ...
    // test of array with elements that reference the entire array
    ...
    // test of list with elements that reference the entire list
    ...
    // test map with a value that references the map
    ...
    // test map with a key that references the map
